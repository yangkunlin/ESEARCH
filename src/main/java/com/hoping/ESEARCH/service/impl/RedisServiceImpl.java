...
import com.hoping.ESEARCH.model.RedisResultModel;
import org.springframework.stereotype.Service;
import com.hoping.ESEARCH.service.RedisService;
import com.hoping.ESEARCH.utils.SortUtil;
import com.hoping.ESEARCH.utils.redis.JedisUtil;
...
public class RedisServiceImpl implements RedisService{
    ...
    private void setRedisResultModelByMap(String dateStr, String key, RedisResultModel<String, Map<String, String>> redisResultModel, int num) {
        ...
        if (JedisUtil.getJedis().exists(key + "_" + dateStr)) {
            redisResultModel.setValue(SortUtil.sortMapByValueContainsHanZi(JedisUtil.getJedis().hgetAll(key + "_" + dateStr), num));
        } else {
