...
public class XiyuanSearchC {
    ...
    @RequestMapping(value = "/XIYUAN/SingleFieldSearch", method = RequestMethod.POST)
...
//        hotField(bodyJSON.getAsString("query_value"));
        ...
        return searchService.singleFieldSearch(ESParams.XIYUAN_INDEX, ESParams.XIYUAN_TYPE,
    ...
    @RequestMapping(value = "/XIYUAN/DoubleFieldSearch", method = RequestMethod.POST)
...
//        hotField(bodyJSON.getAsString("query_value"));
    ...
    @RequestMapping(value = "/XIYUAN/AllFieldSearch", method = RequestMethod.POST)
...
//        hotField(bodyJSON.getAsString("query_value"));
    ...
    public StringBuffer hotFieldSearch(@RequestBody String body) throws Exception {
        ...
        return searchService.hotFieldSearch(ESParams.HOTWORD_INDEX, ESParams.HOTWORD_TYPE, 0, Integer.valueOf(bodyJSON.getAsString("num")));
    ...
    public String recommendSearch(@RequestBody String body) throws Exception {
        ...
        if (bodyJSON.containsKey("type")) {
            ...
            return searchService.recommendSearch(ESParams.XIYUAN_INDEX, ESParams.XIYUAN_TYPE, bodyJSON.getAsString("type"),
